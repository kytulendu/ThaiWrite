...
/****************************************************************************/
struct line_node *copytospace(
    struct line_node *fline,    /* first line to be copied */
    struct line_node *lline,    /* last line to be copied */
    unsigned int fcol,          /* first column in 1'st line, column is origin 0 */
    unsigned int lcol           /* last column in last line, column is origin 0 */
    )
{
...
/****************************************************************************/
void insertlinklist(
    struct line_node *sourceline,
    struct line_node *destline,
...
/****************************************************************************/
void deletelinklist(
    struct line_node *fline,    /* first line to be deleted */
    struct line_node *lline,    /* last line to be deleted */
    unsigned int fcol,          /* first column in 1'st line, origin 0 */
    unsigned int lcol           /* last column in last line, origin 0 */
    )
{
...
void writeblk(
    char file_name[],
    struct line_node *linebegin,
    unsigned int colbegin,
    struct line_node *lineend,
    unsigned int colend                 /* physical column */
    )
{
    FILE *fip;
