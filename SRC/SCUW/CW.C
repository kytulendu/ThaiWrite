...
void main(int argc, char *argv[])
{
    ...
    dispstrhgc(" ñ               Version 1.41               ñ ", 21 - CENTER_FACTOR, 7, REVERSEATTR);
    dispprintf(21 - CENTER_FACTOR, 8, REVERSEATTR,
               " ñ           %11s  %8s          ñ ", prog_date, prog_time);
    dispstrhgc(" ñ        Hercules/EGA/VGA/MCGA/AT&T        ñ ", 21 - CENTER_FACTOR, 9, REVERSEATTR);
    dispstrhgc(" ñ    æ—≤π“‚¥¬  ∂“∫—π∫√‘°“√§Õ¡æ‘«‡µÕ√Ï √Ë«¡°—∫     ñ ", 21 - CENTER_FACTOR, 10, REVERSEATTR);
    dispstrhgc(" ñ  ¿“§«‘™“«‘»«°√√¡§Õ¡æ‘«‡µÕ√Ï §≥–«‘»«°√√¡»“ µ√Ï  ñ ", 21 - CENTER_FACTOR, 11, REVERSEATTR);
/*    dispstrhgc(" ñ          ·≈– ™¡√¡§Õ¡æ‘«‡µÕ√Ï Õ∫®.          ñ ", 21 - CENTER_FACTOR, 12, REVERSEATTR);
    dispstrhgc(" ñ††          ®ÿÃ“≈ß°√≥Ï¡À“«‘∑¬“≈—¬†††          ñ ", 21 - CENTER_FACTOR, 13, REVERSEATTR);
    dispstrhgc(" öïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïõ ", 21 - CENTER_FACTOR, 14, REVERSEATTR);
*/
    dispstrhgc(" ñ            ®ÿÃ“≈ß°√≥Ï¡À“«‘∑¬“≈—¬             ñ ", 21 - CENTER_FACTOR, 12, REVERSEATTR);
    dispstrhgc(" öïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïõ ", 21 - CENTER_FACTOR, 13, REVERSEATTR);
#else
    dispstrhgc(" òïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïô ", 21 - CENTER_FACTOR, 5, REVERSEATTR);
    dispstrhgc(" ñ            CU  WRITER            ñ ", 21 - CENTER_FACTOR, 6, REVERSEATTR);
    dispstrhgc(" ñ               Version 1.2                ñ ", 21 - CENTER_FACTOR, 7, REVERSEATTR);
    dispstrhgc(" ñ               EDA version                ñ ", 21 - CENTER_FACTOR, 8, REVERSEATTR);
    dispstrhgc(" ñ     Õ¿‘π—π∑π“°“√®“° ®ÿÃ“≈ß°√≥Ï¡À“«‘∑¬“≈—¬      ñ ", 21 - CENTER_FACTOR, 9, REVERSEATTR);
    dispstrhgc(" ñ          ¡Õ∫·¥Ë °√–∑√«ßµË“ßª√–‡∑»          ñ ", 21 - CENTER_FACTOR, 10, REVERSEATTR);
    dispstrhgc(" öïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïõ ", 21 - CENTER_FACTOR, 11, REVERSEATTR);
#endif
    if (cu_song)
    {
        cusong();
...
*/
    ...
    {
        blockmsg(10);
        dispstrhgc("¬—ß‰¡Ë‰¥È®—¥‡°Á∫·øÈ¡¢ÈÕ¡Ÿ≈ µÈÕß°“√®—¥‡°Á∫À√◊Õ‰¡Ë (Y/N)?",
