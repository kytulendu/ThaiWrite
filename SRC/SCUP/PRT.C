...
void PrinterLoadLine9pin(char line[])
{
    ...
    font_attr attr;
    int current;                    /* current dot position */
    int ch ;
    current = 0;
    attr = 0;
    clearbuffer();
...
void pretobuffer(font_attr *attr, int *ch, int *current)
{
    ...
    if (((unsigned int) *ch > 0x8e) && ((unsigned int) *ch < 0x9e))
    {
...
void normal_bold(int *ch, int *current, int f, int u)
{
    ...
    switch (level)
    {
        case 2 :
            ...
            for (i = 1; i < 22; i++)
            {
                bmiddle1[pos]   = font[f][((a) * 44) + i]      | font[f][((a) * 44) + i - 1];
                bbelow2[pos]    = u;
                bmiddle2[pos++] = font[f][((a) * 44) + i + 22] | font[f][((a) * 44) + i + 21];
            }
            bmiddle1[pos]   = 0;
            bbelow2[pos]    = u;
            bmiddle2[pos++] = 0;
        ...
        case 1 :
            ...
            for (i = 1; i < 22; i++)
            {
                bupper1[pos]    |= (font[f][((a) * 44) + i]      | font[f][((a) * 44) + i - 1])  << sh;
                bupper2[pos++]  |= (font[f][((a) * 44) + i + 22] | font[f][((a) * 44) + i + 21]) << sh;
            }
            bupper1[pos]    |= 0;
            bupper2[pos++]  |= 0;
            bupper1[pos]    |= 0;
        ...
        case 3 :
            ...
            for (i = 1; i < 22; i++)
            {
                bbelow1[pos]    = font[f][((a) * 44) + i]      | font[f][((a) * 44) + i - 1];
                bbelow2[pos++]  = font[f][((a) * 44) + i + 22] | font[f][((a) * 44) + i + 21];
            }
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = 0;
            bbelow1[pos]    = 0;
...
void normal_bold_enlarge(int *ch, int *current, int f, int u)
{
    ...
    switch (level)
    {
        case 2 :
            ...
            bmiddle1[pos]   = font[f][((a) * 44) + 21] | font[f][((a) * 44) + 20];
            bbelow2[pos]    = u;
            bmiddle2[pos++] = font[f][((a) * 44) + 43] | font[f][((a) * 44) + 42];
            bmiddle1[pos]   = 0;
            bbelow2[pos]    = u;
            bmiddle2[pos++] = 0;
            bmiddle1[pos]   = 0;
        ...
        case 1 :
            ...
            bupper1[pos]    |= (font[f][((a) * 44) + 21] | font[f][((a) * 44) + 20]) << sh;
            bupper2[pos++]  |= (font[f][((a) * 44) + 43] | font[f][((a) * 44) + 42]) << sh;
            bupper1[pos]    |= 0;
            bupper2[pos++]  |= 0;
            bupper1[pos]    |= 0;
            bupper2[pos++]  |= 0;
        ...
        case 3 :
            ...
            bbelow1[pos]      = font[f][((a) * 44) + 21] | font[f][((a) * 44) + 20];
            bbelow2[pos++]    = font[f][((a) * 44) + 43] | font[f][((a) * 44) + 42];
            bbelow1[pos]      = 0;
            bbelow2[pos++]    = 0;
            bbelow1[pos]      = 0;
            bbelow2[pos++]    = 0;
...
void superscript_bold(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        ...
        case 3 :
            ...
            bmiddle1[pos]   = 0;    /* these four lines may be ignore */
            bmiddle2[pos++] = 0;
            bmiddle1[pos]   = 0;
            bmiddle2[pos++] = 0;
            (*current)++;
...
void superscript_enlarge(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        ...
        case 3 :
            ...
            bmiddle1[pos]   = fonts[((a) * 44) + 21];    /* these four lines may be ignore */
...
void superscript_bold_enlarge(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        case 2 :
            ...
            bupper1[pos]    = fonts[((a) * 44) + 21] | fonts[((a) * 44) + 20];
            bmiddle2[pos]   = u;
            bupper2[pos++]  = fonts[((a) * 44) + 43] | fonts[((a) * 44) + 42];
            bupper1[pos]    = 0;
            bmiddle2[pos]   = u;
            bupper2[pos++]  = 0;
            bupper1[pos]    = 0;
...
void subscript_normal(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        ...
        case 3 :
            ...
            bbelow1[pos]    = 0;    /* these four lines may be ignore */
            bbelow2[pos++]  = 0;
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = 0;
            (*current)++;
...
void subscript_bold(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        case 2 :
            ...
            for (i = 0; i < 21; i++)
            {
                bbelow1[pos]    = ((fonts[((a) * 44) + i]      | fonts[((a) * 44) + i + 1])  << 4);
                bbelow2[pos++]  = ((fonts[((a) * 44) + i + 22] | fonts[((a) * 44) + i + 23]) << 4) | u;
            }
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = u;
            bbelow1[pos]    = 0;
        ...
        case 1 :
            ...
            for(i=0;i<21;i++)
            {
                bmiddle1[pos]   |= (fonts[((a) * 44) + i]      | fonts[((a) * 44) + i + 1])  >> (4 - sh);
                bmiddle2[pos++] |= (fonts[((a) * 44) + i + 22] | fonts[((a) * 44) + i + 23]) >> (4 - sh);
            }
            bmiddle1[pos]   |= 0;
            bmiddle2[pos++] |= 0;
            bmiddle1[pos]   |= 0;
        ...
        case 3 :
            ...
            for (i = 0; i < 21; i++)
            {
                bbelow1[pos]    |= (fonts[((a) * 44) + i]      | fonts[((a) * 44) + i + 1])  >> 3;
                bbelow2[pos++]  |= (fonts[((a) * 44) + i + 22] | fonts[((a) * 44) + i + 23]) >> 3;
            }
            bbelow1[pos]    = 0;    /* these four lines may be ignore */
            bbelow2[pos++]  = 0;
            bbelow1[pos]    = 0;
...
void subscript_bold_enlarge(int *ch, int *current, int u)
{
    ...
    switch (level)
    {
        case 2 :
            ...
            bbelow1[pos]    = ((fonts[((a) * 44) + 21] | fonts[((a) * 44) + 20]) << 4);
            bbelow2[pos++]  = ((fonts[((a) * 44) + 43] | fonts[((a) * 44) + 42]) << 4) | u;
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = u;
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = u;
        ...
        case 1 :
            ...
            bmiddle1[pos]   |= (fonts[((a) * 44) + 21] | fonts[((a) * 44) + 20]) >> (4 - sh);
            bmiddle2[pos++] |= (fonts[((a) * 44) + 43] | fonts[((a) * 44) + 42]) >> (4 - sh);
            bmiddle1[pos]   |= 0;
            bmiddle2[pos++] |= 0;
            bmiddle1[pos]   |= 0;
            bmiddle2[pos++] |= 0;
        ...
        case 3 :
            ...
            bbelow1[pos]    |= (fonts[((a) * 44) + 21] | fonts[((a) * 44) + 20]) >> 3;
            bbelow2[pos++]  |= (fonts[((a) * 44) + 43] | fonts[((a) * 44) + 42]) >> 3;
            bbelow1[pos]    = 0;    /* these four lines may be ignore */
            bbelow2[pos++]  = 0;
            bbelow1[pos]    = 0;
            bbelow2[pos++]  = 0;
