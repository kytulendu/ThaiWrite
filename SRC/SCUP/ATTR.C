...
/* Description      :   write subscript character middle and lower          */
/*                           to font character buffer                       */
/* Parameters       :   buf     - font buffer                               */
...
/* Description      :   write subscript character upper and middle          */
/*                          to font character buffer                        */
/* Parameters       :   buf     - font buffer                               */
/*                      middle  - middle subscript buffer                   */
...
/* Description      :   write superscript character upper and middle        */
/*                          to font character buffer                        */
/* Parameters       :   buf     - font buffer                               */
...
/* Description      :   write superscript character middle and lower        */
/*                          to font character buffer                        */
/* Parameters       :   buf     - font buffer                               */
...
/*                      index  - index to text position in graphic buffer   */
