...
int savepconfig(void)
{
    ...
    if ((cfp = fopen(strcat(s1, "cuprint.cfg"), "w")) == NULL)
    {
        fclose(cfp); return (-1);
    }
...
int readpconfig(void)
{
    ...
    char s1[55];
    strcpy(s1, cuprintpath);
    if ((cfp = fopen(strcat(s1, "cuprint.cfg"), "r")) == NULL)
    {
        fclose(cfp);
        return (-1);
    }
    else if (fscanf(cfp, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d ",
    ...
    if (fgets(w1, 200, cfp) == NULL)
    {
        fclose(cfp); return ('3');
    }
    if (fgets(w2, 200, cfp) == NULL)
    {
        fclose(cfp); return ('4');
    }
    if (fgets(w3, 200, cfp) == NULL)
    {
        fclose(cfp); return ('5');
    }
    if (fgets(w4, 200, cfp) == NULL)
    {
        fclose(cfp); return ('6');
    }
    /*
