...
/* Description      :   create combine code printer table for easily use in */
/*                          print_lq function                               */
/* Parameters       :   NONE                                                */
...
void cp_combine_fontlqscr(FONTSCR *combcode, FONTSCR *sara, FONTSCR *wannayok)
{
    ...
    /* combine sara and wannayok with shifting up wannayok 6 bits and or
     * with sara */
    for (index = 0; index < CP_LQCOL; index++)
    {
        combcode->font[index][0] = 0x0f & ((wannayok->font[index][1] >> 3) |
                                    (sara->font[index][0]));
