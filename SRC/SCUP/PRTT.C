...
void printattr(unsigned char attr)
{
    ...
    if (cpi>17)                 /* 20 cpi <=> condense-elite only in draft */
    {
        pattr |= 0x05;
    }
    else if (cpi>12)            /* 17 cpi <=> condense only in draft */
    {
        pattr |= 0x04;
    }
    else if (cpi==12)           /* 12 cpi <=> elite */
    {
        pattr |= 0x01;
    }
...
*/
/*
    putpstring(tsuptop); PrinterLineFeed180inch(00);
    putpstring(tsupupp); PrinterLineFeed180inch(10);
    putpstring(tnortop); PrinterLineFeed180inch(00);
    putpstring(tnorupp); PrinterLineFeed180inch(10);
    putpstring(tsupmid); PrinterLineFeed180inch(00);
    putpstring(tsubtop); PrinterLineFeed180inch(00);
    putpstring(tsubupp); PrinterLineFeed180inch(10);
    underlineactive = 1;
